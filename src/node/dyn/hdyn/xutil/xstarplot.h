...
extern "C" void lux_set_nobuffer();

// These should perhaps be made into "interface" routines someday...

extern "C" int get_mouse_position(unsigned long, float*, float*);
extern "C" void set_default_font(char*);
extern "C" void lux_pause(int);
extern "C" int lux_get_display_width();
extern "C" int lux_get_display_height();
...
#define M_COLOR2 "red3"
#define M_COLOR3 "OrangeRed2"
#define M_COLOR4 "Orange2"
#define M_COLOR5 "orange1"
#define M_COLOR6 "gold"
#define M_COLOR7 "yellow"
#define M_COLOR8 "khaki1"
#define M_COLOR9 "yellow green"
#define M_COLORa "light sea green"
#define M_COLORb "CadetBlue3"
#define M_COLORc "light blue"
#define M_COLORd "plum3"
#define M_COLORe "orchid"
#define M_COLORf "violet"
#define M_COLORg "plum1"
...
void show_main_instructions(unsigned long, float, int, int, bool,
			    int, int, int, int, int);
