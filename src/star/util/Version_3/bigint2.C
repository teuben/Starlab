...
//
//***************************************************************
// modified January 9, 1998, by Chris Nevison
//
// modification repalces the operators +=, -=, and *= with the
// early versions which do not protect against aliasing, as found
// in the file bigalia2.cpp and in an appendix of the case study.
//***************************************************************
//
