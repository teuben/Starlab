...
/*
 *  kepler.h: class for Kepler orbits
 *.............................................................................
...
// kep_config: class to keep track of specific configuration parameters.
...
//-----------------------------------------------------------------------------
//  kepler  --  a representation for the internal degrees of freedom of a
//              2-body system.
//-----------------------------------------------------------------------------
...
class  kepler
{
	...
	// constant of the orbit in the hyperbolic case:

	real  time_of_periastron_passage;    // always set to the time of 
					     //   the most recent periastron
					     //   passage in the elliptical
					     //   case
	...
	real  separation;                    // spatial separation between the
	                                     //   the two stars. NOTE: 
					     //   ALWAYS update separation
	...
	vec  pred_rel_pos;                   // predicted values
	vec  pred_rel_vel;                   // predicted values
	...
	void  kep_to_dyn_story(story *);     // saves essential information on
					     // the kepler class in the dyn
					     // story 
...
//  The following functions transform the relative position and velocity,
//  as well as the other internal variables (`radius' is the separation
//  between the two stars).

        real  advance_to_radius(real);     // transform forwards in time
        real  return_to_radius(real);      // transform backwards in time
...
//  The following functions transform only the predicted relative position
//  and velocity, and predicted mean and true anomaly, but leave all other
//  internal variables unchanged.

        real  pred_transform_to_radius(real, int);
        real  pred_advance_to_radius(real);   // transform forwards in t
        real  pred_return_to_radius(real);    // transform backwards in t
